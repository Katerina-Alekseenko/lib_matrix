...
- Оформи решение как статическую библиотеку с названием *lib_matrix.a* (с заголовочным файлом lib_matrix.h);
...
- Предусмотри Makefile для сборки библиотеки и тестов (с целями all, clean, test, lib_matrix.a, gcov_report);
